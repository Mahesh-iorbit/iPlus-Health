...
public class BPMActivity extends AppCompatActivity implements OnChartGestureListener {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.value)).setText("Pulse Rate");
        ...
        adapter = new CustomAdapter(data, "Pulse Rate", " bpm");
    ...
    private void getData(DisplayMeasurements obj) {
        ...
        if (bp.size() >= 2) {
            LineDataSet bpChartSet = new LineDataSet(bp, "Body Pulse Rate");
        ...
        xAxis.setValueFormatter(new IAxisValueFormatter() {
            ...
            public String getFormattedValue(float value, AxisBase axis) {
                ...
                int index = (int) value;
                Log.d("fsdfygsdhfgshd", "index " + index);
                if (index < xAx.size())
...
//                    String bloodPressure = visitObj.getString("readingValues");
...
//                        data.add(new BodyTempAndSPO2Model(bloodPressure, visit_time.replace("UTC", ""), "BPM", R.drawable.bpmsys, ""));
//                        adapter.notifyDataSetChanged();
//                    }
//
            ...
            if (obj.getMeasure().size() == 0) {
                ...
                for (int i = 0; i < obj.getMeasure().size(); i++) {
                    ...
                    if (!bloodPressure.equalsIgnoreCase("")) {
                        ...
                        data.add(new BodyTempAndSPO2Model(bloodPressure, strDate, "BPM", R.drawable.bpmsys, ""));
                        adapter.notifyDataSetChanged();
                    }
...
//                WindowManager.LayoutParams.FLAG_FULLSCREEN);
    ...
    public void getMeasurementFromCloud() {
        ...
        Call<DisplayMeasurements> call = retrofitClient.create(ServiceApi.class).getBPMMeasure(new SharedPreference(BPMActivity.this).getCurrentPAtient().getSsid(),duration);
    ...
    public void imageToPDF() throws FileNotFoundException {
        try {
            ...
            if (success) {
                ...
                PdfWriter.getInstance(document, new FileOutputStream(dirpath + "/BPM_" + new SharedPreference(getApplicationContext()).getCurrentPAtient().getFirstName() + "_" + Utils.getDateTime() + ".pdf")); //  Change pdf's name.
                document.open();
                ...
                PdfPCell valueCell = new PdfPCell(new Phrase("Value (BPM) "));
                ...
                document.close();
                Toast.makeText(getApplicationContext(), "PDF Saved into " + dirpath + "/BPM_" + new SharedPreference(getApplicationContext()).getCurrentPAtient().getFirstName() + "_" + Utils.getDateTime() + ".pdf", Toast.LENGTH_SHORT).show();
            }
        } catch (Exception e) {
